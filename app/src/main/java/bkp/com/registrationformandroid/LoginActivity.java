...
public class LoginActivity extends AppCompatActivity {
    ...
    private void loginUser() {
        ...
        if(!email.equals("") && !password.equals("")){
            ...
            mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(LoginActivity.this, "You successfully login.", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                        ...
                        Toast.makeText(LoginActivity.this, "Fill valid credientials.", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
            ...
            Toast.makeText(this, "Please fill the credientials.", Toast.LENGTH_SHORT).show();
            loadingBar.dismiss();
        }
